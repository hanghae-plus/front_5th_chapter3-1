...
// toastFn: 사용자에게 알림 메시지를 보여주는 함수를 대체하는 가짜 함수입니다.
// mock: 실제 객체나 함수를 대체하여 테스트 환경에서 제어 가능한 가짜 객체/함수를 만드는 것입니다.
// fn(): Vitest에서 제공하는 모의 함수 생성기로, 함수의 호출 여부와 인자를 추적할 수 있는 가짜 함수를 만듭니다.
const toastFn = vi.fn();

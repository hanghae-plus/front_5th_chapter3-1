...
describe('getWeekDates', () => {
  ...
  it('주의 끝(일요일)에 대해 올바른 주의 날짜들을 반환한다', () => {
    const result = getWeekDates(new Date('2025-05-09'));
    expect(result).toEqual([
      new Date('2025-05-04'),
      new Date('2025-05-05'),
      new Date('2025-05-06'),
...
describe('getWeeksAtMonth', () => {
  ...
  it('2025년 1월 1일의 올바른 주 정보를 반환해야 한다', () => {
    const result = getWeeksAtMonth(new Date('2025-01-01'));
    expect(result).toEqual([
...
describe('getEventsForDay', () => {
  ...
  it('해당 날짜에 이벤트가 없을 경우 빈 배열을 반환한다', () => {
    const currentDate = new Date('2025-07-03').getDate();

    const result = getEventsForDay(events, currentDate);
    expect(result).toEqual([]);
  });
...
describe('formatWeek', () => {
  it('월의 중간 날짜에 대해 올바른 주 정보를 반환한다', () => {
    ...
    expect(result).toEqual('2025년 7월 3주');
  });
  ...
  it('월의 마지막 주에 대해 올바른 주 정보를 반환한다', () => {
    ...
    expect(result).toEqual('2025년 7월 5주');
  });

  it('연도가 바뀌는 주에 대해 올바른 주 정보를 반환한다', () => {
    const result = formatWeek(new Date('2025-12-31'));
    expect(result).toEqual('2026년 1월 1주');
  });
  ...
  it('평년 2월의 마지막 주에 대해 올바른 주 정보를 반환한다', () => {
    ...
    expect(result).toEqual('2025년 2월 4주');
  });
});
